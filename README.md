...
**PuppyWidget Freeware License**

- 개인적·비상업적 용도로 **무료** 사용
- 원본 .exe 파일의 비영리 재배포 허용 (친구/가족/동료에게 공유)
- 다음 행위는 **금지**:
  - 리버스 엔지니어링, 디컴파일, 분해
  - 소스 코드 추출 또는 수정
  - 상업적 재배포 (판매, 광고와 함께 배포 등)
- 본 소프트웨어는 "있는 그대로" 제공되며 어떠한 보증도 없습니다

상업적 사용이나 별도 라이센싱이 필요하시면 [Issues](https://github.com/TaeheeLim/puppy-widget/issues)로 문의해주세요.
